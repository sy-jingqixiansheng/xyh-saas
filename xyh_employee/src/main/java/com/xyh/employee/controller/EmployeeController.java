package com.xyh.employee.controller;
...
import com.xyh.common.poi.ExcelExportUtil;
import com.xyh.common.utils.BeanMapUtils;
import com.xyh.common.utils.DownloadUtils;
import com.xyh.employee.service.*;
import cpm.xyh.entity.employee.*;
...
public class EmployeeController extends BaseController {
    ...
    public Result archives(@PathVariable(name = "month") String month,
    ...
    public Result findArchives(@RequestParam(name = "pagesize") Integer pagesize,
                               @RequestParam(name = "page") Integer page,
                               @RequestParam(name = "year") String year) throws Exception {
        HashMap<String, Object> mapPPY = new HashMap<>();
        mapPPY.put("year",year);
        mapPPY.put("companyId",companyId);
        PageVO<EmployeeArchive> pageVO = archiveService.findSearch(mapPPY, page, pagesize);
        PageResult<EmployeeArchive> pr = new PageResult(pageVO.getTotal(),pageVO.getRows());
        if(pr !=null){
    ...
    public void export(@PathVariable String month) throws Exception {
        ...
        for (EmployeeReportResult tt:list){
            System.out.println(tt);
        }
        //excel
        ExcelWriterBuilder write = EasyExcel.write("D:\\excel\\"+month+"人事报表.xlsx", EmployeeReportResult.class);
        //工作表
